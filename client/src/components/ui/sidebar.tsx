      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "inset"
              ? "left-4 top-4 h-[calc(100svh-theme(spacing.8))] rounded-lg bg-background shadow-sidebar"
              : "",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div className="bg-sidebar-accent/20 rounded-sm size-4 shrink-0" />
      )}
      <div
        className="bg-sidebar-accent/20 rounded-sm h-4 flex-1 max-w-[--skeleton-width]"
        style={
          {
